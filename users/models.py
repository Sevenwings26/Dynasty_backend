...
def password_reset_token_created(reset_password_token, *args, **kwargs):
    ...
    sitelink = "https://arcade-dynasty.vercel.app/"
...
class ExhibitionApplication(models.Model):
    ...
    instagram_id = models.CharField(max_length=100, default='text')
    tiktok_id = models.CharField(max_length=100, default='text')
    facebook_id = models.CharField(max_length=100, default='text')
